...
const Footer = ({ links, contact, logo }) => {
    ...
    return (
        <div className="w-full bg-white mt-16">
                    ...
                    <ul className="text-center lg:text-right flex flex-col items-center lg:items-end">
                        <li className="py-2 text-5xl text-black">
                            {!contact.name ? (
                                ...
                                <Logo
                                    imageUrl={logo}
                                    className="h-10 w-64 mx-4 lg:mx-0 bg-black"
                                />
                            )}
                        </li>
            ...
            <div className="w-full bg-black mx-auto text-white flex justify-center py-1">
                <small>
                    All rights reserved © - AB Siren Soundfactory Oy 2021 -
                    Website by David Larsson
                </small>
            </div>
        </div>
    );
